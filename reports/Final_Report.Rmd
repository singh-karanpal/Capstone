...
The table shows the results of the BiGRU + FastText being evaluated at various thresholds on the validation set. 
...
kable(baseline[1,] %>%
        select(Class, Test.Accuracy, Test.Recall,
...
Figure 4: Precision recall curve for best performing subtheme models which all passes BC Stat's satisfaction condition (> 0.5).  
...
Figure 5: The bar graph compares how the main theme model performed predicting for both Question 1 and Question 2. 
...
Figure 6: First page of our dashboard
