...
Example:
    python src/models/predict_subtheme.py --input_dir=data/ --output_dir=reports/tables/
...
def main(input_dir, output_dir):
    ...
    X_test = pd.read_excel(input_dir + 'interim/question1_models/X_test.xlsx')

    ## Reading y_test
    y_test = pd.read_excel(input_dir + 'interim/question1_models/y_test.xlsx')
	...
	# Padding comments
        ...
        print(padded_docs_comments.shape)
